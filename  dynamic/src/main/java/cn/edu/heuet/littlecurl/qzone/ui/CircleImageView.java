...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView1_civBorderWidth1, mBorderWidth);
        mBorderColor = a.getColor(R.styleable.CircleImageView1_civBorderColor1, mBorderColor);
        mBorderOverlay = a.getBoolean(R.styleable.CircleImageView1_civBorderOverlay1, mBorderOverlay);
        mFillColor = a.getColor(R.styleable.CircleImageView1_civFillColor1, mFillColor);
        a.recycle();
