...
public class CollectAdapter extends ArrayAdapter<briefAnimalData> {
    ...
    boolean praise;
    public CollectAdapter(@NonNull Context context, int resource, @NonNull List<briefAnimalData> objects, boolean praise) {
